...
public class EditarAlunos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        editarAlunoButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                editarAlunoButtonActionPerformed(evt);
            }
        });
        ...
        tituloLabel.setText("EDIÇÃO DE ALUNOS");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(154, 154, 154)
                .addComponent(editarAlunoButton)
    ...
    private void editarAlunoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarAlunoButtonActionPerformed
        ...
        try{
            ...
            UFUAcademi.gerenciadorAlunos.editar(EscolherAluno.indiceAlunoEscolhido,nome,dataNascimento,cpf,endereco,sexo);
            super.dispose();
        }
    ...
    }//GEN-LAST:event_editarAlunoButtonActionPerformed
    ...
    /**
     * Preenche os elementos TextFields com os dados do aluno escolhido
     * @param nome
     ...
     * @param sexo 
     */
    public void setTextFields(String nome,String dataNascimento,String cpf,String endereco,String sexo){
        nomeTextField.setText(nome);
        dataNascimentoTextField.setText(dataNascimento);
        cpfTextField.setText(cpf.replace(".", "").replace("-",""));
        enderecoTextField.setText(endereco);
        if (sexo.equals("Masculino")) sexoMasculinoCheckBox.setSelected(true);
        else if (sexo.equals("Feminino")) sexoFemininoCheckBox.setSelected(true);
    }
